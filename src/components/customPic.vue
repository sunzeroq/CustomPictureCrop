  ...
  <div class="custom-container">
    ...
    <div class="custom-draw-content">
      <div ref="canvasDiv" class="custom-canvas">
        ...
        ></canvas>
        <canvas ref="bufferCanvas" id="buffer" style="width:100%;opacity:0;position:absolute;"></canvas>
...
.custom-container {
  ...
  .custom-draw-header {
    ...
    .custom-draw-info {
      ...
      border-width: 0;
      box-shadow: 02px6px0rgba (114, 124, 245, 0.5);
    }
  }
  .custom-draw-content {
    position: absolute;
